...
public class Company {
    ...
    public Company(Date paymentDate, String companyName, double amount, String currency, double rate, String activityCode, Optional<Double> tax) {
